...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra barnehofte
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "barnehofte")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "barnehofte"))`'
...
f <- barnehofte::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
